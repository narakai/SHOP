...
public class OthersIndianaRecordAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OthersIndianaRecordAdapter(Context context, List<MineOrderInfo> list) {
